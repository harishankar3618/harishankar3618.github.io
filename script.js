...
const bootLines = [
  ...
  { text: '[OK]  Initializing LangGraph agent runtime...', cls: 'boot-ok', delay: 820 },
  { text: '[INFO] Detected: 247 Excel files at your company', cls: 'boot-info', delay: 1000 },
  { text: '[INFO] Detected: 42 manual approval chains still running', cls: 'boot-info', delay: 1150 },
  { text: '[OK]  Loading enterprise automation protocols...', cls: 'boot-ok', delay: 1300 },
...
function initTerminal() {
  ...
  const commands = {
    ...
    about: () => [
      ...
      { text: '  Role:       Associate AI Automation Engineer', cls: '' },
      { text: '  Company:    TechD Cybersecurity Limited (Jan 2026 – Present)', cls: '' },
      { text: '  Location:   Ahmedabad, India', cls: '' },
      ...
      { text: '  Coffee:     98% · Sleep: NULL · Agents: ∞', cls: 't-success' },
      { text: '  Status:     Open to opportunities', cls: 't-success' },
    ],

    skills: () => [
      { text: '> Running capability scan...', cls: 't-info' },
      { text: '  [████████████████████] AI/Agents   — LangGraph, FastAPI, Agentic Design', cls: 't-success' },
      { text: '  [████████████████████] Enterprise  — SharePoint, Graph API, Power Automate', cls: 't-success' },
      { text: '  [████████████████░░░░] Backend     — Node.js, Flask, Laravel, FastAPI', cls: 't-success' },
      { text: '  [████████████████░░░░] Frontend    — React, Next.js, TypeScript, Tailwind', cls: 't-success' },
      { text: '  [██████████████░░░░░░] Databases   — PostgreSQL, MongoDB, Supabase', cls: 't-success' },
      { text: '  [████████████░░░░░░░░] Security    — VAPT, OWASP, Burp Suite, SIEM', cls: 't-success' },
      { text: '  [██████████████████∞∞] Adaptability— Loading. Never finished.', cls: 't-info' },
    ],

    projects: () => [
      { text: '> Fetching deployment manifest...', cls: 't-info' },
      { text: '  [PROD] BD AI Assistant       — LangGraph agent for Teams, live SharePoint CRM', cls: 't-success' },
      { text: '  [PROD] PMO Lifecycle Portal  — Graph API auto-fill, 4 depts, zero email handovers', cls: 't-success' },
      { text: '  [PROD] BD Lifecycle Flows    — 6 Power Automate flows, quote→invoice pipeline', cls: 't-success' },
      { text: '  [OSS]  SecureScope           — VAPT automation, 60% faster assessments', cls: '' },
      { text: '  [OSS]  Malware Detector      — Python engine, 90%+ accuracy, <2% CPU', cls: '' },
      { text: '  [OSS]  Phishing Extension    — DOM analysis, VirusTotal, zero latency', cls: '' },
      { text: '', cls: '' },
    ...
    experience: () => [
      ...
      { text: '  ● Jan 2026–Present: Associate AI Automation Engineer @ TechD Cybersecurity', cls: '' },
      { text: '    └─ LangGraph Teams agent, PMO portal, 6 Power Automate flows, SOC', cls: 't-muted' },
      { text: '  ● Dec 2024–Apr 2025: Cybersecurity Intern @ Tinkering Hub', cls: '' },
      { text: '    └─ Malware detection engine (90%+ accuracy), phishing extension', cls: 't-muted' },
      { text: '  ● Dec 2024–Jan 2025: Cybersecurity Intern @ SkillVertex', cls: '' },
      { text: '    └─ VAPT assessments, SQLi/XSS/IDOR, CVSS-scored reports', cls: 't-muted' },
    ],
